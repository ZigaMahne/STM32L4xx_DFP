 ...
 * $Revision:    V1.3.0
 *
 * Project:      Flash Programming Functions for ST STM32L4Px/Qx Flash
 * --------------------------------------------------------------------------- */
...
/* Note:
   ...
   STM32L4Px devices have Dual Bank Flash configuration. */
...
static u32 GetFlashBankMode (void)
{
  ...
  /* For 512-Kbyte Flash memory devices, do not care about DBANK */
  if (gFlashSize > 0x00080000)
  {
